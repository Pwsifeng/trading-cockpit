...
const treeData = [
  {
    title: '中共杭州萧山交通投资集团有限公司委员会（13560人）',
    key: '0-0',
    children: [
      {
        title: '中共杭州萧山交通投资集团有限公司行政一支部委员会（1260人）',
        key: '0-0-0',
      },
      {
        title: '中共杭州萧山交通投资集团有限公司行政二支部委员会（569人）',
        key: '0-0-1',
      },
      {
        title: '中共杭州萧山城区建设有限公司支部委员会（897人）',
        key: '0-0-2',
      },
      {
        title: '中共杭州萧山地铁投资开发有限公司支部委员会（2454人）',
        key: '0-0-3',
      },
      {
        title: '中共杭州市萧山公共交通有限公司委员会（1662人）',
        key: '0-0-4',
        children: [
          {
            title: '中共杭州市萧山公共交通有限公司行政一支部委员会',
            key: '0-0-2-0',
          },
          {
            title: '中共杭州市萧山公共交通有限公司行政二支部委员会',
            key: '0-0-2-1',
          },
          {
            title: '中共杭州市萧山公共交通有限公司行政三支部委员会',
            key: '0-0-2-2',
          },
          {
            title: '中共杭州市萧山公共交通有限公司行政四支部委员会',
            key: '0-0-2-3',
          },
          {
            title: '中共杭州市萧山公共交通有限公司行政五支部委员会',
            key: '0-0-2-4',
          },
          {
            title: '中共杭州市萧山公共交通有限公司行政六支部委员会',
            key: '0-0-2-5',
          },
          {
            title: '中共杭州市萧山公共交通有限公司一车队支部委员会',
            key: '0-0-2-6',
          },
          {
            title: '中共杭州市萧山公共交通有限公司行政二支部委员会',
          ...
          {
            title: '中共杭州市萧山公共交通有限公司大江东车队支部委员会',
            key: '0-0-2-12',
          },
        ],
      },
      {
        title: '中共杭州萧山长途汽车运输有限公司总支部委员会（1376人）',
        key: '0-0-5',
        children: [
          {
            title: '中共杭州萧山长途汽车运输有限公司修理分公司支部委员会',
            key: '0-0-5-0',
          },
          {
            title: '中共杭州萧山长途汽车运输有限公司客运分公司支部委员会会',
            key: '0-0-5-1',
          },
          {
            title: '中共杭州萧山长途汽车运输有限公司行政支部委员会',
            key: '0-0-5-2',
          },
        ]
      },
      {
        title: '中共杭州萧山路桥工程有限公司支部委员会（892人）',
        key: '0-0-6',
      },
      {
        title: '中共杭州萧山国际机场高速公路建设开发有限公司支部委员会（763人）',
        key: '0-0-7',
      },
      {
        title: '中共杭州萧山交通建设管理有限公司支部委员会（1862人）',
        key: '0-0-8',
      },
      {
        title: '中共杭州萧山浦阳江建设开发有限公司支部委员会（1967人）',
        key: '0-0-9',
      },
      {
        title: '中共杭州萧山交投能源公司联合支部委员会（1258人）',
        key: '0-0-10',
      },
      {
        title: '中共杭州萧山交投智慧交通新镇开发有限公司支部委员会（1472人）',
        key: '0-0-11',
      },
      {
        title: '中共杭州萧山交投公路养护服务有限公司支部委员会（1571人）',
        key: '0-0-12',
      },
      {
        title: '中共杭州市萧山区收费公路服务中心退休支部委员会（586人）',
        key: '0-0-13',
      },
    ],
  },
...
export default function Party() {
  ...
  return (
    ...
    <div id='party' >
      <div className='party_bg'></div>
      <div className='party_bg2'></div>
      ...
      <div className='party-middle animate__animated animate__fadeInLeft'>
        <div className='zhishu'>
        ...
        <div className='tongling'>
          <p>党建统领网格智治</p>

          <div className='wangge'>

            <div className='biaogetu'>
      ...
      <div className='party-right animate__animated animate__fadeInLeft'>
        ...
        <div className='bangfu'>
          ...
          <ul>
            ...
            <li>
              <span>萧山交投召开学习宣传贯彻党的二十大专题会议</span>
              <span>2022-12-02</span>
            </li>
            <li>
